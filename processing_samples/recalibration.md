...
# $FILE= your_deduplicated_BAM_file  // in a cluster:  FILE=${FILES[$SLURM_ARRAY_TASK_ID]} 
# ${newfile}= new_name_for_your_BAM_file
```
...
# Compare the First vs Second round of recalibration tables:
time $GATK \
