...
# ------------------------------------------------------------------------------------------------------------------------------------------------
# Description:
#     PERL script that reads one Population directory (among many) and foreach fasta alignment sequences file having a protein coding gene from Ae. aegypti, 
# finds its ortholog and put them together in a single fasta file. This process is repeated across all genes from Ae. aegypti having orthologues gene (~12,000)
# detected in a TARGET POPULATION.
#
# This PERL script requires only one argument: "Population target name", which is the name of the directory with all gene fasta files. 
# ------------------------------------------------------------------------------------------------------------------------------------------------
